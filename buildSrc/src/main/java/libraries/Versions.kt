...
const val appCompatVersion = "1.4.1" //todo: https://androidx.tech/artifacts/appcompat/appcompat/
    ...
    const val sdp_android = "1.1.0"
    const val ssp_android = "1.1.0"
    ...
    const val work_runtime_ktx = "2.4.0"
    ...
    const val okhttp_logging_interceptor = "3.9.1"
    ...
    const val firebase_config = "20.0.2"
    const val firebase_crashlytics = "17.1.0"
    const val firebase_authentication = "21.0.1"
    const val firebase_referral = "2.2"
    const val firebase_dynamic_links = "20.1.0"
    const val firebase_database = "20.0.0"
    ...
    const val auto_starter = "1.0.6"
    const val subsampling_scale_image_view = "3.10.0"
