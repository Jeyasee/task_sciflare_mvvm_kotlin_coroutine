package com.david.support.utility.shared_preference;
...
public final class SharedPreferences {
     ...
     * <strong>Note that the native implementation of {@link android.content.SharedPreferences#getStringSet(String,
